...
constexpr Sha256Digest kThinkingToggleTemplateDigest{
    0xc7, 0x26, 0xbb, 0x99, 0x1c, 0x31, 0x50, 0xf3, 0xee, 0x3d, 0x69, 0x09, 0x30, 0xf4, 0x3e, 0xd1, 0xe7, 0xc2, 0x8d, 0xce, 0xf2, 0x7c, 0xfb, 0xc6, 0xde, 0x34, 0x00, 0xdb, 0x1d, 0xa2, 0xa9, 0xa6,
};

constexpr Sha256Digest kReasoningEffortTemplateDigest{
    0x51, 0x4d, 0x53, 0x04, 0xfc, 0xac, 0x63, 0xbd, 0xa6, 0x0e, 0x6f, 0xaf, 0x86, 0x0d, 0x56, 0x57, 0x01, 0x0c, 0xf4, 0x3c, 0xbc, 0x4c, 0x63, 0x3c, 0x8b, 0xf6, 0x78, 0xee, 0x18, 0x4e, 0x7a, 0x37,
};
...
RenderedChat CompiledChatTemplate::render(const std::vector<ChatMessage>& messages,
    ...
    // Propagate this template's chat_style to the render options so reasoning-effort
    // selection and any future per-style rendering branches can read it.
    options.chat_style = chat_style_;
